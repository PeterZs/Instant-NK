...
class NeRFGUI:
    ...
    def test_step(self):
        ...
        outputs = self.trainer.test_gui(self.cam.pose, self.cam.intrinsics, self.W, self.H, self.bg_color,frame_id=0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dyna_mode', type=str, default='deform', help="dynamic mode, supports (deform , fourier)")
